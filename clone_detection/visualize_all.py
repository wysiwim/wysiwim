...
sys.path.append("../visualization_algorithms/synth_high")
sys.path.append("../visualization_algorithms/keywords_picto")
import pandas as pd
...
def visualize(algorithm, lang, code, out_path, dataset, algo, cid):
    try:
    ...
    for _, r in code_ds.iterrows():
        ...
        if lazy_mode:
            if os.path.exists(out_path):
                ...
                work.append((vis, lang, r["code"], out_path, dataset, algo, cid))
